...
$(function() {
    ...
    describe('The menu', function() {
        ...
        it('toggles visibility on click', function() {
            ...
            expect(slidemenu.classList.contains('menu-hidden')).toBe(false);
    ...
    describe('Initial Entries', function() {
        ...
        it('Has at least 1 entry element in the feed container', function() {
    ...
    describe('New Feed Selection', function() {
        ...
        it('Content changes on feed reload', function (done) {
            const newFeed = document.querySelector('.feed').textContent;
            expect(initialFeed).not.toEqual(newFeedData);
            done();
        });
    });
}());
